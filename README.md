...
<div align="center">
  ...
  <h3 align="center">Aeroport MS Common Lib</h3>
</div>
...
1. Per iniziare, clona il repository `xtr-aeroports-common-lib` sul tuo computer locale usando Git.
   Apri il terminale e esegui il seguente comando:
   ```
   git clone https://<repository>/xtr-aeroports-common-lib.git cd
   xtr-aeroports-common-lib
   ```
